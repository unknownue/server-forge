#!/bin/bash
# One-click 4-GPU TP=4 benchmark for Qwen/Qwen3.6-27B.
#
# Usage:
#   bash nodes/ubuntu26-node1-server/bench/bench-4gpu-tp4.sh [BACKEND]
#
# BACKEND: sglang (default) or vllm
#
# Steps: download model -> start server TP=4 -> smoke test -> AIPerf benchmark
...
# ── Step 2: Start server ──
echo "[2/5] Starting $BACKEND TP=4 server..."
